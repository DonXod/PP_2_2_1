...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("ford",3)));
      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("honda",4)));
      ...
      List<User> usersFord = userService.listUsersByCar("ford",3);
      for (User user : usersFord) {
         System.out.println("Id = "+user.getId());
         System.out.println("First Name = "+user.getFirstName());
         System.out.println("Last Name = "+user.getLastName());
         System.out.println("Email = "+user.getEmail());
